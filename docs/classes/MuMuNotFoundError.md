...
> **new MuMuNotFoundError**(`path`): `MuMuNotFoundError`

Defined in: [src/errors.ts:72](https://github.com/PiratePeep/mumuplayer/blob/main/src/errors.ts#L72)
...
The absolute path to MuMuManager.exe that was not found.
...
Defined in: [src/errors.ts:67](https://github.com/PiratePeep/mumuplayer/blob/main/src/errors.ts#L67)
