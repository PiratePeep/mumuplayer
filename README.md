...
- Targets one, many, or all player instances with [`VmIndex`](docs/type-aliases/VmIndex.md)
...
- **[Full API Reference](docs/README.md)** — auto-generated TypeDoc Markdown
- **[api.json](api.json)** — structured TypeDoc JSON for programmatic consumption
